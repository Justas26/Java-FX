...
public class Controller {
    ...
    public void create() {
        ...
        if (!comboNum.getSelectionModel().isEmpty()) {
            members = comboNum.getSelectionModel().getSelectedItem().toString();
        } else {
        ...
        if (!Validation.isValidTeamName(teamName1)) {
            ...
            Dakar dakar = new Dakar(teamName1, nameSurname1, sponsors, racingCar, Integer.parseInt(members), user.getId());
    ...
    public void search() {
        updateTableFromDB(teamName.getText()); // get entries according team name
    }
    ...
    public void update() {
        if(role.getText().equals("Admin")) {
            ...
            if (!Validation.isValidTeamName(teamName1)) {
                ...
                Dakar dakar = new Dakar(teamid, teamName1, nameSurname1, sponsors, racingCar, Integer.parseInt(members), Integer.parseInt(userid));
                DakarDAO dakarDAO = new DakarDAO();
